        ...
        <div class="col-md-12">
          <div class="tile">
            <section class="invoice">
              <div class="row mb-4">
                <div class="col-6">
                  <h2 class="page-header"><i class="fa fa-globe"></i> Snack-fit delivery man </h2>
                </div>
                <div class="col-6">
...
<body>
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="iadded">
						<h2>Manage <b>Delivery man</b><a href="ajouterlivreur.html"><button type="button" class="btn btn-success">add delivery man</button></a></h2>
					</div>
					<div class="col-sm-6">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody><?PHP foreach($listelivreur as $row)
            {
	?>
                    <tr>
	...
	<input type="hidden" value="<?PHP echo $row['idlivreur']; ?>" name="idlivreur" >
						...
						<td><a href="modifierlivreur.php?idlivreur=<?PHP echo
		                $row['idlivreur']; ?>" class="edit" data-toggle="modal" ><i 
			...
			<div class="modal-content">
				<form>
					<div class="modal-header">						
						<h4 class="modal-title">Add delivery man</h4>
