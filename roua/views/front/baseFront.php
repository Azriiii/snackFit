            ...
            <div>
                <ul>
					...
					if ( Config::getUserSession() == null ) {
						echo '<li><a href="/views/front/signup.php"><i class="fa fa-user"></i> SignUp</a></li>';
						echo '<li><a href="/snack-fit/roua/views/front/login.php"><i class="fa fa-user"></i> Login</a></li>';
					} else {
						echo '<li><a href="/views/front/profile"><i class="fa fa-user"></i>' . Config::getUserSession()->getUsername() . '</a></li>';
						echo '<li><a href="/views/front/profile/fidelities.php"><i class="fa fa-user"></i> My requests</a></li>';
